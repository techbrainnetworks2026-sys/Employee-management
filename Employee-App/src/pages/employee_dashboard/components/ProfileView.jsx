...
const ProfileView = ({ user, setUser, editProfile, setEditProfile }) => {
    // Cropping State
            ...
            <div className="profile-card">
                <div className="profile-header-section">
                    ...
                    <div className="profile-main-info">
                        <h2>{user.name}</h2>
                        <p className="designation-text">{user.designation}</p>
                    </div>
                </div>
                ...
                <div className="profile-form-grid">
                    <div className="form-group">
                        <label>Name</label>
                        <input name="name" value={user.name} disabled={!editProfile} onChange={handleProfileChange} />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <select name="bloodGroup" value={user.bloodGroup || ""} disabled={!editProfile} onChange={handleProfileChange}>
                    ...
                    <div className="form-group">
                        <label>Mobile</label>
                        <input name="mobile" value={user.mobile} disabled={!editProfile} onChange={handleProfileChange} />
                    </div>
                    <div className="form-group">

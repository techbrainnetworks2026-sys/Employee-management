                    ...
                    <table className="lh-table">
                        ...
                        <tbody>
                            {leaves.length > 0 ? (
                                leaves.map(leave => (
                                    <tr key={leave.id}>
                                        <td data-label="From Date" className="lh-col-date"><span className="lh-td-value">{leave.fromDate}</span></td>
                                        <td data-label="To Date" className="lh-col-date"><span className="lh-td-value">{leave.toDate}</span></td>
                                        <td data-label="Type" className="lh-col-type"><span className="lh-td-value">{leave.type}</span></td>
